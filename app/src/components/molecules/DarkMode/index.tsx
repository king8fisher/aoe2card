...
export function DarkModeButton() {
	...
	return (
		<>
			<button id="dark-theme-toggle" type="button"
				className="text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-lg text-sm p-2">
				<svg id="dark-theme-toggle-dark-icon" className="w-5 h-5 text-transparent hidden"
					fill="currentColor"
					viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
					<path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
				</svg>

				<svg id="dark-theme-toggle-light-icon" className="w-5 h-5 text-transparent"
